...
public:
	...
	virtual void setLineColor(Color lineColor) = 0;					// 윤곽선 색 설정
	virtual void setLineWidth(int lineWidth) = 0;					// 윤곽선 두께 설정
	virtual void setLinePattern(int linePattern) = 0;				// 윤곽선 패턴 설정
	virtual void setFillColor(Color FillColor) = 0;					// 칠하기 색 설정
	virtual void setFillPattern(int fillPattern) = 0;				// 칠하기 패턴 설정
